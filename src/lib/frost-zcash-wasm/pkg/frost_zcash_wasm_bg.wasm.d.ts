...
export const create_signing_package: (a: number, b: number, c: number, d: number, e: number, f: number) => [number, number];
...
export const get_group_public_key: (a: number, b: number) => [number, number];
export const get_public_key: (a: number, b: number) => [number, number];
export const init: () => void;
export const verify_signature: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number) => [number, number];
